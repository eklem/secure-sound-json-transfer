# p2p-json-sound-transfer
Transferring JSON from phone to phone(s) through sound. And encrypt the characters before transferred as sound. Experiments to see if it will work.
